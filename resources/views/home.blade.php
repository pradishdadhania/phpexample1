...
<div class="item mb-5">
    ...
    <h3 class="title mb-1"><a href="blog-post.html">{{$info->title}} </a></h3>
    <div class="meta mb-1"><span class="date">{{$info->id}}</span><span class="time">5 min read</span><span class="comment"><a href="#">8 comments</a></span></div>
    <div class="intro">{{$info->body}}</div>
